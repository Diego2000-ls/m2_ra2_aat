...
<html lang="es">
  ...
  <body>
    <div class="container">
        <h1>Nuevas Reservaciones</h1>
        <a href="reservaciones"><button class="btn btn-danger">Pagina Reservaciones</button></a>
        <div class="formularios_contenedor">
        <form action="<?php echo base_url('agregar_reservacion'); ?>" method="post">
            <div class="mb-8">
